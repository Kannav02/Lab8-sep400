...
{
    int arg1;
    const unsigned char arg2[5][BUF_LEN]=messages;
...
void *send_func(void *arg)
{
    struct threadArgs* local_args=(struct thread_args*)arg;
    int fd=local_args->arg1;
    ...
    {
        encrypt(messages[i],encryptedText[i];
